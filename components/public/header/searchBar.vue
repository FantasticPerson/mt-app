    ...
    <div class="search-panel">
        <el-row class="m-header-searchbar">
            ...
            <el-col :span="6" class="right">
                <ul class="security">
                    <li><i class="refuced"><p class="txt">随时退</p></i></li>
                    <li><i class="single"><p class="txt">不满意面单</p></i></li>
                    <li><i class="orderdue"><p class="txt">过期退</p></i></li>
                </ul>
...
export default {
    data(){
        return {
            isFocus :false,
            search:'',
            hotList:['火锅','火锅','火锅','火锅','火锅','火锅','火锅'],
            searchList:['故宫','故宫','故宫','故宫','故宫','故宫','故宫','故宫']
        }
    },
    methods:{
        focus:function(){
